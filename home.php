...
<body>
  ...
  <section class="home_cont">
    <div class="main_descrip">
      <h1>The Hidden Shelf</h1>
      <p>Discover Hidden Worlds on Every Shelf</p>
  ...
  <section class="about_cont">
    ...
    <div class="about_descript">
      ...
      <p>At The Hidden Shelf, we believe every book holds a hidden world waiting to be discovered. Our bookstore is a sanctuary for curious minds, passionate readers, and seekers of timeless stories. We invite you to explore, imagine, and uncover the treasures tucked away on every shelf.
      </p>
  ...
  <section class="questions_cont">
    ...
    <p>At The Hidden Shelf, your journey matters to us. Whether you have questions, need recommendations, or simply want to chat about books, our dedicated team is here to guide you with care and passion. We're just a message away from helping you find your next great read.</p>
